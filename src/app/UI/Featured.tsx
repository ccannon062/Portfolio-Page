        ...
        <div className="max-w-7xl mx-auto py-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
            <motion.div
              ...
              className="group relative w-full h-auto bg-[#3B475C]/50 rounded-lg border border-[#D3AC2B]/30 text-white overflow-hidden hover:bg-[#3B475C]/80 transition-all duration-300"
            >
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold mb-3 group-hover:text-[#D3AC2B] transition-colors duration-300">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  <span className="px-2 py-1 bg-[#293040] rounded text-xs">
                    React
                  </span>
                  <span className="px-2 py-1 bg-[#293040] rounded text-xs">
                    PostgreSQL
                ...
                <a
                  ...
                  target="_blank"
                  className="w-full flex items-center justify-center gap-2 px-3 py-2 bg-[#D3AC2B] text-[#293040] hover:bg-[#c09a23] rounded text-sm font-semibold transition-colors cursor-pointer"
                >
            ...
            >
              ...
              <div className="p-6">
                ...
                <button className="w-full flex items-center justify-center gap-2 px-3 py-2 bg-[#D3AC2B] text-[#293040] hover:bg-[#c09a23] rounded text-sm font-semibold transition-colors">
                  <FiGithub className="w-4 h-4" />
                  View Code
                </button>
              </div>
